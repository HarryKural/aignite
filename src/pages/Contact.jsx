...
function Contact() {
    return (
      <>
        ...
        <section className="flex flex-col md:flex-row items-start justify-start px-8 md:px-18 py-10 gap-30">
        {/* left Side */}
        <div className="md:w-1/2 text-left">
            ...
            <div className="mt-10">
              <label for="name" className="text-xl font-semibold">Name</label>
            ...
            <div className="mt-6">
              <label for="email" className="text-xl font-semibold">Email</label>
            ...
            <div className="mt-6">
              <label for="message" className="text-xl font-semibold">Message</label>
